...
public class PCA9685PwmControl {
    ...
    private final BigDecimal FREQUENCY = new BigDecimal("50"); // Frequency for PWM. Limit is variable, based on the
                                                               // steps or whatever: Working: 100Hz:4096Steps,
                                                               // 400Hz:2500Steps, 500Hz: 2000Steps. So set
                                                               // PWM_MAX_VALUE to a matching value.
    ...
    private static final Logger logger = LoggerFactory.getLogger(pca9685controlBinding.class);
    ...
    public PCA9685PwmControl(int I2CAddress) {
        ...
        try {
            ...
            // Init Provider - it controls the Pin-Management: SetPWM and so on...
            gpioProvider = new PCA9685GpioProvider(bus, I2CAddress, FREQUENCY, FREQUENCY_CORRECTION_FACTOR);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void setOff(Pin pin) {
        ...
        gpioProvider.setPwm(arg0, arg1, arg2);
    }
